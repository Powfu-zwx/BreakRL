...
\textbf{Maximum-entropy RL's way}: while keeping the score high, \underline{preserve as many viable routes as possible}. Randomness is worth pursuing in its own right --- it brings exploration, robustness, and makes you harder to counter.
