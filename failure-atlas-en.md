...
When training won't converge, look up the **symptom you're seeing**. Each entry gives the causal mechanism, a reproducible ablation, and a fix; every experiment comes from this book's chapter notebooks — follow the links to read them online, or re-run locally to verify. The full chapters are written in Chinese; this atlas is provided in English. [中文版](failure-atlas.md)
...
- **Reproduce**: [Policy Gradient chapter](notes/policy-gradient/pg_experiments.ipynb) Figure 1.
...
- **Reproduce**: [Policy Gradient chapter](notes/policy-gradient/pg_experiments.ipynb) Figure 3; for continuous control, see the $\alpha=0$ arm in Figure 1 of the [SAC chapter](notes/sac/sac_experiments.ipynb).
...
- **Reproduce**: [Actor-Critic chapter](notes/actor-critic/ac_experiments.ipynb) Figures 1 and 3.
...
- **Reproduce**: [PPO chapter](notes/ppo/ppo_experiments.ipynb) Figures 1 and 3.
...
- **Reproduce**: [DQN chapter](notes/dqn/dqn_experiments.ipynb) Figure 2.
...
- **Reproduce**: [DQN chapter](notes/dqn/dqn_experiments.ipynb) Figure 3; [SAC chapter](notes/sac/sac_experiments.ipynb) Figure 3 (the $\tau=1.0$ arm).
...
- **Reproduce**: [SAC chapter](notes/sac/sac_experiments.ipynb) Figure 2 (single vs double Q); the extreme offline version is entry 8.
...
- **Reproduce**: [Offline RL chapter](notes/offline-rl/offline-rl_experiments.ipynb) Figure 1.
...
- **Reproduce**: [Bandits chapter](notes/multi-armed-bandit/multi-armed-bandit_experiments.ipynb) Figures 1 and 2 (greedy strands about a third of seeds on a suboptimal arm).
...
- **Reproduce**: [TD learning chapter](notes/temporal-difference-learning/temporal-difference-learning_experiments.ipynb) Figure 3 (Cliff Walking: SARSA vs Q-learning).
...
- **Reproduce**: [TD learning chapter](notes/temporal-difference-learning/temporal-difference-learning_experiments.ipynb) Figures 1 and 2.
...
- **Reproduce**: [Model-based RL chapter](notes/model-based-rl/model-based-rl_experiments.ipynb) Figure 3 (contrast Figure 1: in deterministic environments planning is nearly free).
...
- **Reproduce**: [RLHF chapter](notes/rlhf/rlhf_experiments.ipynb) Figure 2 ($\beta=0$ collapses throughout), Figure 1 (the extrapolation fork).
...
- **Reproduce**: [DPO chapter](notes/dpo/dpo_experiments.ipynb) Figure 3 ($\beta$ sweep and drift), Figure 2 (implicit-reward extrapolation).
...
- **Reproduce**: [GRPO chapter](notes/grpo/grpo_experiments.ipynb) Figure 3 (cold start vs weak-teacher start; the zero-signal group fraction stays at 100%).
...
- **Reproduce**: [Decision Transformer chapter](notes/decision-transformer/decision-transformer_experiments.ipynb) Figure 1 right (OOD targets fail), Figure 2 (three data-quality ceilings).
...
- **Reproduce**: [Decision Transformer chapter](notes/decision-transformer/decision-transformer_experiments.ipynb) Figure 3 (gridworld: offline Q-learning stitches the 14-step optimum; DT at the optimal target fails to reach the goal in 60/90 episodes).
